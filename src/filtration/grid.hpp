...
{
  std::size_t Nx, Ny, Nz;   ///< number of cells in each dimension
  std::vector<scalar> data; ///< data
  scalar at(std::size_t i, std::size_t j, std::size_t k)
...
{
  std::size_t Nx, Ny, Nz;       ///< number of vertices in each dimension
